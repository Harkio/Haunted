...
<img src="http://haunted.ie/forms/upload/<?php echo $img; ?>" float:left; height=400px; width=400px; hspace="20"; />
<h2 align="right"size="1">Author: <?php echo $row['author']; ?></h2>
<h2 align="right">Title: <?php echo $row['title']; ?></h2>
