...
$alwidth = 310;            // maximum allowed width, in pixels
$alheight = 210;           // maximum allowed height, in pixels
...
if(isset($_FILES['fileup']) && strlen($_FILES['fileup']['name']) > 1) {
  ...
  if($err == '') {
    if(move_uploaded_file($_FILES['fileup']['tmp_name'], $uploadpath)) { 
      ...
      echo "<br/><img src=\"$uploadpath\" width=\"300\" height=\"200\">";
      echo "<br/><a href=http://haunted.ie/forms.php>Back to Form Page</a>";
    }
