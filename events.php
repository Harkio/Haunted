...
<div class="portfolio-container" id="columns">
    ...
    <ul>
      <li class="one-fourth web">
        <p> <a title="Caption Text" href="<?php echo $row['province']; ?>" class="portfolio-item-preview" data-rel="prettyPhoto"><img src="http://haunted.ie/forms/upload/<?php echo $url; ?>" alt="" width="210" height="145" class="portfolio-img pretty-box"></a> </p>
